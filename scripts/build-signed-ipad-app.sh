...
plutil -insert schemaVersion -integer 1 "$notes_provenance_plist"
...
plutil -insert profileExpirationUTC -string "$notes_selected_expiration" "$notes_provenance_plist"
plutil -convert json -o "$notes_provenance_path" "$notes_provenance_plist"
