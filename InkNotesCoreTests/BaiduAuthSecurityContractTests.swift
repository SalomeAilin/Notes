...
struct BaiduAuthSecurityContractTests {
  ...
  func brokerProtocolFoundationRemainsSealed() throws {
    ...
    #expect(protocolSource.contains("enum BaiduConnectionFailureV1"))
    #expect(protocolSource.contains("case connectionExpired"))
    #expect(protocolSource.contains("var suggestedActionTitle: String"))
    #expect(protocolSource.contains("笔记没有上传"))
